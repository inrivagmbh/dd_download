...
/**
 * Test case for class Tx_DdDownload_Domain_Model_Categories.
 *
 * @version $Id$
 ...
 */
class Tx_DdDownload_Domain_Model_CategoriesTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_DdDownload_Domain_Model_Categories
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_DdDownload_Domain_Model_Categories();
	}
