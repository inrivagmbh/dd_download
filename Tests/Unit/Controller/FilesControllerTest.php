...
/**
 * Test case for class Tx_Dd_download_Controller_FilesController.
 *
 * @version $Id$
 ...
 */
class Tx_Dd_download_Controller_FilesControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
